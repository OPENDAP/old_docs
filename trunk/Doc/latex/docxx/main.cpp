...
/*@ ----------------------------------------------------------------------------
   ...
   Identification:
   Id: main.cpp,v 3.4 1998/07/31 09:31:29 bzfzoeck Exp 
...
main(int argc, char **argv)
{
	...
	switch(argv[i][1])
	{
		...
		printf( "       DDDDDD      OOOOO       CCCCC\n" ) ;
		printf( "\n" ) ;
		printf( "                Version 3.2 (July 31, 1998)\n" ) ;
		printf( "\n" ) ;
		printf( "  (c) 1995-97 by Malte Zoeckler,\n" );
		...
		printf( "    -F            show filenames with path in man-pages\n" ) ;
		...
		printf( "    -S            sort entries alphabetically\n");
