...
|.glo.aux|.  Sadly, this double extension is necessary because 
...
|.glo.bbl| file generated by \bibTeX{} from |.glo.aux|.

In this basic interface the \textsf{glsplain} style is used always.

\section{The generated glossary}

Once \LaTeX{}ed the document, you \bibTeX{} the |.glo.aux| file which
generates the glossary into the |.glo.bbl| with the following \TeX{}
format:
\begin{itemize}
